# Accessibility Statement – Codex KPI Sparkline Card

## Overview
This document outlines the accessibility compliance of the **Codex KPI Sparkline Card** Power BI custom visual.
...
## 7. Summary
**Codex KPI Sparkline Card** meets Microsoft's accessibility requirements and is designed to be usable by all users, including those relying on assistive technologies.