# Security Document – Codex KPI Sparkline Card

## Overview
This document describes the security characteristics of the **Codex KPI Sparkline Card** Power BI custom visual. It confirms compliance with Microsoft's security and certification requirements.
...
## 8. Summary
**Codex KPI Sparkline Card** is sandbox-compliant, contains no external dependencies, performs no external communication, and adheres to all Microsoft Power BI security requirements.