# Developer Guide – Codex KPI Sparkline Card
...
## 2. Capabilities
- Data roles: 
   - measure (Measure, numeric or text)
   - target (Measure, numeric)
   - sparkline (Measure, numeric)
   - sparklineCategory (Grouping)
   - sortOrder (Measure, numeric)
- Format pane cards: valueCard, targetCard, sparklineCard
...
## 5. Accessibility
- ARIA labels on interactive elements (the card is focusable and handles click and context menu via Enter/Space)
